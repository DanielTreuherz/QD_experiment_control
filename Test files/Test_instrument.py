        ...
        try:
            ...
            with conn:
                while data := conn.recv(1024):
                    ...
                    other_name = "Labview" if name == "Python" else "Python"
                    ...
                    if cmd == other:
                        ...
                        s1, s2 = last["Python"], last["Labview"]
                        res1, pairs = "", []
...
threading.Thread(target=start_device, args=(5025, "Python"), daemon=True).start()
try:
    start_device(5026, "Labview")
